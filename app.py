...
if st.session_state.tela_ativa == "cotacao":
    ...
    with c2:
        ...
        # --- INCLUSÃO DOS NOVOS PRODUTOS NA COLUNA 2 ---
    ...
    # Matemática de Pesos e Embalagem (Atualizada com Vestido=0.55kg, Conjunto=0.50kg, Boné=0.10kg)
    peso_pecas_puro = (
    ...
    total_pecas = qtd_calcas + qtd_bermudas + qtd_shorts + qtd_gola_o + qtd_tshirt + qtd_polo + qtd_vestidos + qtd_conjuntos + qtd_bones
    ...
    with c3:
        ...
        valor_nf_meia = (
            ...
            (qtd_vestidos * 45) + (qtd_conjuntos * 50) + (qtd_bones * 15) # Valores NF estimados de segurança para novas peças
        )
