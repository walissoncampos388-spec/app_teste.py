...
with st.container():
    ...
    with col_centro:
        try:
            ...
            pass
        st.markdown("<h2 style='text-align:center; color:#1e3a8a; font-family:sans-serif; font-weight:1000; margin:0;'>⚡ CIA DO JEANS LOGISTICA INTELIGENTE</h2>", unsafe_allow_html=True)
