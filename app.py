...
# Cabeçalho Ajustado: Banner Menor e Logo Mantida em Tamanho Grande
st.markdown(
    f"""
    <div style='background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 60%, #1e40af 100%); padding: 4px 12px 8px 12px; border-radius: 16px; text-align: center; margin-bottom: 24px; box-shadow: 0 15px 20px -5px rgba(15, 23, 42, 0.2); position: relative; overflow: visible;'>
        ...
        <div style='margin-bottom: 0px; position: relative; z-index: 2;'>
